...
inputDeviations=args[1]
min_support1=float(args[2])
min_threshold1 =float(args[3])
support_threshold1=float(args[4])
confidence_threshold1=float(args[5])
#inputDeviations="Experiment1.csv"
#min_support1=0.01
#min_threshold1 = 0.001
#support_threshold1=0.001
#confidence_threshold1=0.25

#Step1: load data

#df = pd.read_csv("Experiment1.csv", names = ['Layers'], sep = ',')
df = pd.read_csv(inputDeviations, names = ['Layers'], sep = ',')
...
frequent_itemsets = apriori(df, min_support = min_support1, use_colnames = True)
...
rm_results = association_rules(frequent_itemsets, metric = "support", min_threshold = min_threshold1)
#rm_results
...
#**********************Select threshold*************************************
support_threshold=support_threshold1
...
for index, row in filtered_result_1.iterrows():
    ...
    x_Support1=filtered_result_1.loc[index].at["support"].round(4)
    x_confidence=filtered_result_1.loc[index].at["confidence"].round(4)
    x_activity =''
    x_operation=''
    x_role=''
    x_erole=''
...
for index, row in filtered_result_2.iterrows():
    ...
    x_Support1=filtered_result_2.loc[index].at["support"].round(4)
    x_confidence=filtered_result_2.loc[index].at["confidence"].round(4)
    x_activity =''
    x_operation=''
    x_role=''
    x_erole=''
...
for index, row in filtered_result_3.iterrows():
    ...
    x_Support1=filtered_result_3.loc[index].at["support"].round(4)
    x_confidence=filtered_result_3.loc[index].at["confidence"].round(4)
    x_activity =''
    x_operation=''
    x_role=''
    x_erole=''
...
for index, row in filtered_result_4.iterrows():
    ...
    x_Support1=filtered_result_4.loc[index].at["support"].round(4)
    x_confidence=filtered_result_4.loc[index].at["confidence"].round(4)
    x_activity =''
    x_operation=''
    x_role=''
    x_erole=''
...
df_SystemDeviatingPattern.to_csv('SystemDeviatingPatterns.csv', index=False, sep=';')
...
for index1, row1 in filtered_result5.iterrows():
    ...
    x_Support1=filtered_result5.loc[index1].at["support"].round(4)
    x_confidence=filtered_result5.loc[index1].at["confidence"].round(4)
    x_activity = ''
    x_operation= ''
    x_role= ''
    x_erole= ''
...
df_UserDeviatingPattern.to_csv('UserDeviatingPatterns.csv', index=False, sep=';')
...
print('-->The csv file <SystemDeviatingPatterns.csv> contains system and roles anomalous behavioral patterns.')
print('-->The csv file <UserDeviatingPatterns.csv> contains users anomalous behavioral patterns.')
