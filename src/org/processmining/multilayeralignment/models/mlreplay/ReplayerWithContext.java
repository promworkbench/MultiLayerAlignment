...
import org.processmining.multilayeralignment.algorithms.syncproduct.MlBasicSyncProductFactoryWithContext;
...
public class ReplayerWithContext {
	...
	final MlBasicSyncProductFactoryWithContext factory;
	...
	public ReplayerWithContext(ReplayerParameters parameters, Petrinet net, Marking initialMarking, Marking finalMarking,
	...
	protected MlBasicSyncProductFactoryWithContext createSyncProductFactory(ReplayerParameters parameters, Petrinet net, Marking initialMarking,
			...
			return new MlBasicSyncProductFactoryWithContext(net, classesP, processEvClass2id,classesD, dataEvClass2id ,mapping1,mapping2 ,costLM,costMM,costPM, costLM, costSM,costDM,
