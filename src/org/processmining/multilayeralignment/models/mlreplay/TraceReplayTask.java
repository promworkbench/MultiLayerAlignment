...
public class TraceReplayTask implements Callable<TraceReplayTask> {
	...
	public TraceReplayTask( boolean withContext, Replayer replayer, ReplayerParameters parameters, XTrace pTrace, int pTraceIndex,XTrace dTrace, int dTraceIndex,
	...
	public TraceReplayTask call() throws LPMatrixException {
		...
		if (original < 0) {
			...
			synchronized (this.replayer.factory) {
				...
				product = this.replayer.factory.getSyncProduct(processTrace,dataTrace, transitionList, parameters.partiallyOrderEvents);
