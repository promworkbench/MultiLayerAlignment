...
@Plugin(name = "1.Projection to Process Log", returnLabels = { "Visualized Log-Model Alignment Projection to Log" }, returnTypes = { }, parameterLabels = { "Log-Model alignment" }, userAccessible = true)
@Visualizer
public class MLAWithContextVisualizationPlugin {
	...
	public JComponent visualize1(PluginContext context, MLAWithContextReplayResult logReplayResult) {
		...
		return new MLAWithContextResultVisualizationPanel (logReplayResult, inProcesslog, inDatalog, context.getProgress());
	}	
