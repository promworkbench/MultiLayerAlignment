...
public class MLAWithContextResultDOVisualizationPanel2 extends JPanel implements ActionListener {
...
//	protected ProMPropertiesPanel logAlignmentPanel;
	...
	public MLAWithContextResultDOVisualizationPanel2(MLAWithContextReplayResult replayResult, XLog inProcessLog, XLog inDataLog, Progress progress) { 
	...
	private Component createBottomPanel() {
		...
		JLabel linkLabel = SlickerFactory.instance().createLabel("Select visualization:x2");
