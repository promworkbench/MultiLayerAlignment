...
public class MultiLayerReplayResultVisualizationPanel extends JPanel implements ActionListener {
	...
	protected MultiLayerReplayResult replayResult;
...
//	protected ProMPropertiesPanel logAlignmentPanel;
	...
	public MultiLayerReplayResultVisualizationPanel(MultiLayerReplayResult replayResult,XLog inProcessLog,XLog inDataLog, Progress progress) {
	...
	protected void addMultiLayerAlignments(){
		for (int i = (selectedPage - 1) * numOfalignmentsPerPage; i < Math.min(selectedPage * numOfalignmentsPerPage, replayResult.size()); i++) {
			...
			MultiLayerInstanceConformanceView alignmentPanel = createMultiLayerInstanceView(traceIndex,nodeInstance,stepTypes,nodeInstanceVOL,stepTypesVOL,rearrangedNodeInstance,processTrace,dataTrace);
	...
	protected MultiLayerInstanceConformanceView createMultiLayerInstanceView(String traceIndex,List<Object> nodeInstance, List<StepTypes> stepTypes, List<Object> nodeInstanceVOL, List<StepTypesVOL> stepTypesVOL,List<Object> rearrangedNodeInstances,XTrace processTrace,XTrace dataTrace) {
		return new MultiLayerInstanceConformanceView(traceIndex,nodeInstance,stepTypes,nodeInstanceVOL,stepTypesVOL,rearrangedNodeInstances,40,processTrace,dataTrace);
	}
