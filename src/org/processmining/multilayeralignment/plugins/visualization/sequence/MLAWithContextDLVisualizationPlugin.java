...
@Plugin(name = "2.Projection to Data Log", returnLabels = { "Visualized Log-Model Alignment Projection to Log" }, returnTypes = {  }, parameterLabels = { "Log-Model alignment" }, userAccessible = true)
@Visualizer
public class MLAWithContextDLVisualizationPlugin {
	@PluginVariant(requiredParameterLabels = { 0 })
	public JComponent visualize1(PluginContext context, MLAWithContextReplayResult logReplayResult) {
		...
		//return new MLAWithContextResultDLVisualizationPanel (logReplayResult, inProcesslog, inDatalog, context.getProgress());
		return new MLAWithContextResultDLVisualizationPanel (logReplayResult, inDatalog, context.getProgress());
	}	
