...
public class MultiLayerReplayResultDOVisualizationPanel extends JPanel implements ActionListener {
...
//	protected ProMPropertiesPanel logAlignmentPanel;
	...
	public MultiLayerReplayResultDOVisualizationPanel(MultiLayerReplayResult replayResult, Progress progress) {
	...
	protected void addInterLevelAlignments(){
		for (int i = (selectedPage - 1) * numOfalignmentsPerPage; i < Math.min(selectedPage * numOfalignmentsPerPage, replayResult.size()); i++) {
			...
			MultiLayerInstanceDOConformanceView alignmentPanel = createMultiLayerInstanceDOView(traceIndex,nodeInstance,stepTypes,nodeInstanceVOL,stepTypesVOL,rearrangedNodeInstance);
	...
	protected MultiLayerInstanceDOConformanceView createMultiLayerInstanceDOView(String traceIndex,List<Object> nodeInstance, List<StepTypes> stepTypes, List<Object> nodeInstanceVOL, List<StepTypesVOL> stepTypesVOL,List<Object> rearrangedNodeInstances) {
		return new MultiLayerInstanceDOConformanceView(traceIndex,nodeInstance,stepTypes,nodeInstanceVOL,stepTypesVOL,rearrangedNodeInstances,40);
	}
	...
	protected Component createLegendPanel() {
		...
		JLabel TSM = factory.createLabel(" -Totally synchronous move");
		...
		JLabel TSMP = factory.createLabel(" -Totally synchronous move with wrong role");
		...
		JLabel PSM = factory.createLabel(" -Partially synchronous move");
		...
		JLabel PSMP = factory.createLabel(" -Partially synchronous move with wrong role");
		...
		JLabel MM = factory.createLabel(" -Move on model");
		...
		JLabel PLM = factory.createLabel(" -Move on process log");
		...
		JLabel DLM = factory.createLabel(" -Move on data log");
