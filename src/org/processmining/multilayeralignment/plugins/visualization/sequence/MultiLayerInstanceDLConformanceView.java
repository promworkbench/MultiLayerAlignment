...
public class MultiLayerInstanceDLConformanceView extends JComponent implements MouseListener, MouseMotionListener {
	...
	public MultiLayerInstanceDLConformanceView(String traceLabel, List<Object> nodeInstance, List<StepTypes> stepTypes, List<Object> nodeInstanceVOL, List<StepTypesVOL> stepTypesVOL,
	...
	public MultiLayerInstanceDLConformanceView(String traceLabel, List<Object> nodeInstance, List<StepTypes> stepTypes, List<Object> nodeInstanceVOL, List<StepTypesVOL> stepTypesVOL,List<Object> rearrangedNodeInstances,
			XTrace dataTrace) {
		...
		if (rearrangedNodeInstanceVDL!= null) {
           ...
           if (moveColor.equals(Color.pink)){
				...
				dataInfo=name.substring(index1+1, name.indexOf("#"));
					...
					ProcessInfo="Context: "+ProcessInfo.substring(0, index1);
				    roleInfo="Illegitimate Role, Actor: CAS";
					//roleInfo="Illegitimate Role";
				    dataInfo="Expected D.O. : "+dataInfo;
					}
				    //PSM move
	...
	public void rearrange(String traceLabel, List<Object> nodeInstance, List<StepTypes> stepTypes, List<Object> nodeInstanceVOL, List<StepTypesVOL> stepTypesVOL,List<Object> rearrangedNodeInstances) {
		...
		for (int step=0; step < nodeInstance.size(); step++) {
			String readMove= nodeInstance.get(step).toString().substring(0,nodeInstance.get(step).toString().indexOf("#"));
