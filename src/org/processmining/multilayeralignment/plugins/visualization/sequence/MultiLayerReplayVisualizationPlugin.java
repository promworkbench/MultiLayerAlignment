...
@Plugin(name = "1.Projection to Process Log", returnLabels = { "Visualized Log-Model Alignment Projection to Log" }, returnTypes = { JComponent.class }, parameterLabels = { "Log-Model alignment" }, userAccessible = true)
@Visualizer
public class MultiLayerReplayVisualizationPlugin {
	...
	public JComponent visualize1(PluginContext context, MultiLayerReplayResult logReplayResult) {
		...
		return new MultiLayerReplayResultVisualizationPanel (logReplayResult, inProcesslog, inDatalog, context.getProgress());
	}	
