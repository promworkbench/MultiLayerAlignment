...
public class MultiLayerReplayResultDLVisualizationPanel  extends JPanel implements ActionListener {
	...
	public MultiLayerReplayResultDLVisualizationPanel (MultiLayerReplayResult replayResult,XLog inDataLog, Progress progress) {
	...
	protected void addMultiLayerAlignments(){
		for (int i = (selectedPage - 1) * numOfalignmentsPerPage; i < Math.min(selectedPage * numOfalignmentsPerPage, replayResult.size()); i++) {
			...
			// ALIGNMENT PANEL
			MultiLayerInstanceDLConformanceView alignmentPanel = createMultiLayerInstanceDLView(traceIndex,nodeInstance,stepTypes,nodeInstanceVOL,stepTypesVOL,rearrangedNodeInstance,dataTrace);
	...
	protected MultiLayerInstanceDLConformanceView createMultiLayerInstanceDLView(String traceIndex,List<Object> nodeInstance, List<StepTypes> stepTypes, List<Object> nodeInstanceVOL, List<StepTypesVOL> stepTypesVOL,List<Object> rearrangedNodeInstances, XTrace dataTrace) {
		return new MultiLayerInstanceDLConformanceView(traceIndex,nodeInstance,stepTypes,nodeInstanceVOL,stepTypesVOL,rearrangedNodeInstances,40, dataTrace);
	}
