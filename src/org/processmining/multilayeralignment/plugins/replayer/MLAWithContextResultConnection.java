...
public class MLAWithContextResultConnection extends AbstractConnection {
	...
	public MLAWithContextResultConnection(String label,MLAWithContextReplayResult repResult,CSVFile DataModel,CSVFile OrganisationalModel,Petrinet net,XLog processLog, XLog dataLog)
	{
		super(label);
