package org.processmining.multilayeralignment.algorithms.implementations;


import java.util.Arrays;

//import nl.tue.alignment.algorithms.datastructures.HashBackedPriorityQueue;
import org.processmining.multilayeralignment.algorithms.HashBackedPriorityQueue;
//import nl.tue.alignment.algorithms.Queue;
import org.processmining.multilayeralignment.algorithms.Queue;
...
import org.processmining.multilayeralignment.algorithms.SortedHashBackedPriorityQueue;
//import nl.tue.alignment.algorithms.datastructures.VisitedHashSet;
import org.processmining.multilayeralignment.algorithms.VisitedHashSet;
//import nl.tue.alignment.algorithms.VisitedSet;
import org.processmining.multilayeralignment.algorithms.VisitedSet;
...
abstract class AbstractReplayAlgorithm extends AbstractReplayAlgorithmDataStore {
	...
	protected void fillStatistics(int[] alignment) {
		...
		replayStatistics.put(Utils.Statistic.LMCOST,getCostForType(alignment, SyncProduct.LOG_MOVE, SyncProduct.LOG_MOVE));
		replayStatistics.put(Utils.Statistic.MMCOST, getCostForType(alignment, SyncProduct.MODEL_MOVE, SyncProduct.TAU_MOVE));
		replayStatistics.put(Utils.Statistic.SMCOST,getCostForType(alignment, SyncProduct.SYNC_MOVE, SyncProduct.SYNC_MOVE));
		replayStatistics.put(Utils.Statistic.PMCOST,getCostForType(alignment, SyncProduct.PSYNC_MOVE, SyncProduct.PSYNC_MOVE));
		replayStatistics.put(Utils.Statistic.DMCOST,getCostForType(alignment, SyncProduct.DLOG_MOVE, SyncProduct.DLOG_MOVE));
